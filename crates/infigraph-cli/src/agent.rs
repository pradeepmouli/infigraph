...
pub(crate) fn infigraph_instructions() -> &'static str {
    // The same shared sources `infigraph install` deploys (#168), not a copy of
    // them: this text used to be a hand-maintained duplicate of agents.md and
    // drifted. None of these project-level targets can load skills, so the
    // tool-routing body is inlined, exactly as for the Cursor and Windsurf
    // install artifacts.
    concat!(
        include_str!("../resources/integrations/shared/agents.md"),
        "\n",
        include_str!("../resources/integrations/shared/tool-routing.md"),
    )
}
