...
///
/// Was ignored as #34: symbols pruned as "stale" during `index_group`'s
/// reindex. It passes consistently since the daemon rework (#159, the
/// watch-daemon split), which replaced the in-process watcher paths it
/// exercised.
#[test]
