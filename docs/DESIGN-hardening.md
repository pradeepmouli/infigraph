...
- [ ] R3.1.3 — unreplayable WAL crashes the whole process on open, before quarantine can run ([#92](https://github.com/pradeepmouli/infigraph/issues/92)) — found 2026-08-20 via three matching macOS crash reports
